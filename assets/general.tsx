...
export const TelegramIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeWidth={1.25}
      d="m9.988 12.84 2.701 3.071c1.001 1.138 1.502 1.707 2.025 1.569.524-.139.704-.888 1.063-2.385l1.992-8.307c.554-2.306.83-3.46.215-4.028-.615-.569-1.68-.146-3.812.7l-9.89 3.927c-1.704.677-2.557 1.015-2.61 1.597a.982.982 0 0 0-.001.179c.052.582.904.923 2.606 1.606.772.309 1.158.463 1.434.76.031.033.061.067.09.103.255.317.364.732.581 1.563l.407 1.556c.212.809.318 1.213.595 1.268.277.055.518-.28 1-.95l1.604-2.229Zm0 0-.265-.276c-.301-.314-.452-.47-.452-.666 0-.195.15-.352.452-.666l2.978-3.104"
    />
  </svg>
)
...
export const GithubIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.25}
      d="M8.334 17.14c-2.857.964-5.238 0-6.667-2.973"
    />
    <path
      stroke="#FDFDFD"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={1.25}
      d="M8.334 18.333v-2.701c0-.499.153-.932.4-1.324.17-.268.053-.65-.253-.733-2.536-.698-4.314-1.818-4.314-5.537 0-.966.317-1.875.873-2.666.139-.197.208-.295.225-.384.017-.09-.012-.206-.07-.438-.236-.947-.22-1.953.133-2.86 0 0 .731-.238 2.395.801.38.238.57.356.737.383.167.027.39-.03.838-.14A7.943 7.943 0 0 1 11.25 2.5c.71 0 1.34.082 1.953.234.447.11.67.167.838.14.167-.027.357-.145.737-.383 1.664-1.039 2.395-.8 2.395-.8.353.906.369 1.912.133 2.859-.058.232-.087.349-.07.438.016.089.086.187.224.384.557.791.874 1.7.874 2.666 0 3.719-1.779 4.84-4.315 5.537-.306.084-.422.465-.252.733.247.392.4.825.4 1.324v2.701"
    />
  </svg>
)
...
export const DiscordIcon = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.25}
      d="m1.5 16.5 6.29-6.29m0 0L1.5 1.5h4.167l4.543 6.29m-2.42 2.42 4.543 6.29H16.5l-6.29-8.71M16.5 1.5l-6.29 6.29"
    />
  </svg>
)
