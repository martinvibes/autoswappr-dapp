...
export function SelectBaseToken() {
  ...
  return (
    <div className="flex relative justify-center items-center mt-8 pt-[10] h-[110vh]  w-full px-4 overflow-hidden">
      ...
      <div className="w-full h-[120px] bg-main-bg bg-cover absolute bottom-0 transform rotate-180"></div>
    </div>
  );
}
